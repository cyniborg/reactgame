# React Multiple Choice Game

With this project I wish to create a SPA that is also a game. This game is a basic multiple choice answers and has questions based on different genres. 

## The way this app works

1. All data is fetched from a REST API (currently Wordpress). All API calls are made with Axios. 
